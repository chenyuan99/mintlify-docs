export declare const locales: readonly ["en", "cn", "zh", "zh-Hans", "zh-Hant", "zh-CN", "zh-TW", "es", "fr", "fr-CA", "fr-ca", "ja", "jp", "ja-jp", "ja-JP", "pt", "pt-BR", "de", "ko", "it", "ru", "ro", "cs", "id", "ar", "tr", "hi", "sv", "no", "da", "lv", "nl", "uk", "vi", "pl", "uz", "he", "ca", "fi", "hu"];
export declare const localeDisplayNames: {
    ...
    readonly 'zh-CN': "Simplified Chinese";
    readonly 'zh-TW': "Traditional Chinese";
    readonly es: "Spanish";
    readonly fr: "French";
...
export declare const LlmSupportedLocaleCodes: ("en" | "cn" | "zh" | "zh-Hans" | "zh-Hant" | "zh-CN" | "zh-TW" | "es" | "fr" | "fr-CA" | "fr-ca" | "ja" | "jp" | "ja-jp" | "ja-JP" | "pt" | "pt-BR" | "de" | "ko" | "it" | "ru" | "ro" | "cs" | "id" | "ar" | "tr" | "hi" | "sv" | "no" | "da" | "lv" | "nl" | "uk" | "vi" | "pl" | "uz" | "he" | "ca" | "fi" | "hu")[];
