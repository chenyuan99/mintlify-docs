...
import { sdkSchema } from '../reusable/sdk.js';
...
export type GroupNavigation<T extends NavigationType> = T extends 'default' ? Omit<BaseGroupSchema, 'sdk'> & z.infer<typeof SomeApiSchema> & {
    sdk?: z.infer<typeof sdkSchema>;
    pages?: PageOrGroupNavigation<'default'>[];
} : Omit<BaseGroupSchema, 'root' | 'sdk'> & {
