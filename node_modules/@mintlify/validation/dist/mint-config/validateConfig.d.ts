import { z } from 'zod';
import { type SourceRefDocsConfig } from './schemas/v2/properties/navigation/sourceRef.js';
...
export declare function validateSourceRefDocsConfig(value: unknown): {
    success: false;
    error: z.ZodError<any>;
} | {
    data: SourceRefDocsConfig;
    warnings: z.ZodIssue[];
    success: true;
    error?: never;
};
