import { sdkSchema, } from '../../mint-config/schemas/v2/properties/index.js';
import { compareNodes } from '../order.js';
...
export function readSdkConfig(value) {
    if (!('sdk' in value))
        return undefined;
    const parsed = sdkSchema.safeParse(value.sdk);
...
export const TAB_NODE_DATA_FIELDS = ['icon', 'sdk', ...COMMON_DIVISION_NODE_DATA_FIELDS];
