import { GroupConfig, TabConfig, AnchorConfig, LanguageConfig, VersionConfig, DropdownConfig, ProductConfig, MenuItemConfig, SdkConfig } from '../../mint-config/schemas/v2/properties/index.js';
...
export declare function readSdkConfig(value: object): SdkConfig | undefined;
...
export declare const TAB_NODE_DATA_FIELDS: readonly ["icon", "sdk", "hidden", "href", "asyncapi", "openapi", "global"];
...
export declare const VERSION_NODE_DATA_FIELDS: readonly ["default", "tag", "hidden", "href", "asyncapi", "openapi", "global"];
...
export declare const GROUP_NODE_DATA_FIELDS: readonly ["icon", "hidden", "tag", "expanded", "public", "root", "asyncapi", "openapi", "sdk"];
