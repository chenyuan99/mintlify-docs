...
import { compareNodes, generateKeyBetween, generateNKeysBetween } from '../order.js';
import { isGlobalNode } from '../schema.js';
import { createIdGenerator, isProductConfig, isLanguageConfig, isVersionConfig, isTabConfig, isMenuItemConfig, isDropdownConfig, isAnchorConfig, isGroupConfig, readSdkConfig, } from './common.js';
...
export function docsConfigToNavigationTree(navigation) {
    ...
    const parentStack = [{ id: 0 }];
    const lastOrderByParent = new Map();
    const getNextOrder = (parentId) => {
        var _a;
        const next = generateKeyBetween((_a = lastOrderByParent.get(parentId)) !== null && _a !== void 0 ? _a : null, null);
        lastOrderByParent.set(parentId, next);
        return next;
    };
    const getCurrentParent = () => {
        var _a;
        return (_a = parentStack[parentStack.length - 1]) !== null && _a !== void 0 ? _a : { id: 0 };
    };
