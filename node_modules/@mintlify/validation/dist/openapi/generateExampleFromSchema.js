...
export const generateExampleFromSchema = (schema, depth = 0) => {
    ...
    // OAS 3.1 `examples` array form: fall back to the first example when the
    // singular `example` keyword is absent.
    if (((_a = schema.examples) === null || _a === void 0 ? void 0 : _a[0]) !== undefined) {
