...
import { addKeyIfDefined, copyExampleIfDefined, copyKeyIfDefined, getFileLikeStringEncoding, getSchemaContentEncoding, getSchemaContentMediaType, structuredDataContentTypes, } from './utils.js';
export class SchemaConverter extends BaseConverter {
    ...
    combineTopLevelSchemas(path, schema1, schema2, depth = 0) {
        ...
        const mergedContentMediaType = (_a = getSchemaContentMediaType(schema2)) !== null && _a !== void 0 ? _a : getSchemaContentMediaType(schema1);
        const mergedContentEncoding = (_b = getSchemaContentEncoding(schema2)) !== null && _b !== void 0 ? _b : getSchemaContentEncoding(schema1);
        if (mergedContentMediaType !== undefined) {
            Object.assign(combinedSchema, { contentMediaType: mergedContentMediaType });
        }
        if (mergedContentEncoding !== undefined) {
            Object.assign(combinedSchema, { contentEncoding: mergedContentEncoding });
        }
        ...
        const example1 = ((_c = schema1.examples) === null || _c === void 0 ? void 0 : _c[0]) !== undefined ? schema1.examples[0] : schema1.example;
        const example2 = ((_d = schema2.examples) === null || _d === void 0 ? void 0 : _d[0]) !== undefined ? schema2.examples[0] : schema2.example;
...
export const inferType = (schema) => {
    ...
    if (schema.format !== undefined ||
        getSchemaContentMediaType(schema) !== undefined ||
