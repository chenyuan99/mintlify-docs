...
export type StaticPropsDeploymentType = Pick<DeploymentType, 'basePath' | 'customDomains' | 'disable404SuggestedPages' | 'disableAiChat' | 'entitlements' | 'featureFlags' | 'feedback' | 'relatedPages' | 'inkeep' | 'isWhiteLabeled' | 'subdomain' | 'trieve' | 'userAuth' | 'docsConfig' | 'assistant' | 'searchFilterCounts'> & {
