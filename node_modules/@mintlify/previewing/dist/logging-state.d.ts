...
export declare const removeLog: (target: React.ReactNode) => void;
export declare const replaceLog: (target: React.ReactNode, next: React.ReactNode) => void;
export declare const removeSpinnerLogs: () => void;
